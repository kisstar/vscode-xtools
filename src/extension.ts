...
import { addLog, convertLog, removeLog } from './commands';
...
export function activate(context: vscode.ExtensionContext) {
  ...
  const disposableConvertLog = vscode.commands.registerCommand(
    'xtools.convert_log',
    convertLog
  );
  ...
  context.subscriptions.push(disposableConvertLog);
